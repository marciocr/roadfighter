...
/* SDL3: SDL_DisplayFormat() n√£o existe mais (n√£o h√° mais um "formato da
   tela" global e impl√≠cito). O equivalente √© converter explicitamente
   pra o mesmo formato de pixel da superf√≠cie da janela, usando
...
CRoadFighter::CRoadFighter(void)
{
...

	{
		...
		char *text=	   "        "
				   ...
				   "        "
				   "PROGRAMMING: Santi OntaÒÛn (Brain)    "
				   "GRAPHICS: Miikka Poikela (McBain)     "
				   "MUSIC/SFX: Jorrith Schaap (Jorito)    "
				   "BETA TESTING: Jason Eames (JEames), Miikka Poikela (McBain), Jorrith Schaap (Jorito), Santi OntaÒÛn (Brain)"
				   "        ";
		c.r=c.g=c.b=128;
